                ...
                <div class="wrapper-content">
                    ...
                    <div class="ibox-content m-b-sm border-bottom">
                        <div class="p-xs">
                            ...
                            <h2>Bem vindo a Central de Ajuda</h2>
                            <span>Listamos abaixo as perguntas mais frequentes. Sinta-se à vontade para explorar!</span>
                        </div>
                    </div>
                        ...
                        <div class="forum-item active">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <router-link to="/admin/help/topic" class="forum-item-title">
                                        General Discussion
                                    </router-link>
...
<script>
    module.exports = {
        ...
        methods : {
            addList(){
                this.list.push({ message: this.entrada})
                this.entrada = ""
            },
            removeList(index){
